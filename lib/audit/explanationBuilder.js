 ...
 * @param {string} [category] The rule category ('redundancy' | 'tier-mismatch' | 'usage-efficiency' | 'governance' | 'underutilization')
 * @returns {Object} Standardized recommendation object
 */
export function buildRecommendation(ruleId, ruleMath, priority, provider, customContext = {}, category = '') {
