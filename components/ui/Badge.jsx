  ...
  return (
    <div
      className={cn(
        ...
        // Variants
        variant === 'default' && "border-border bg-card px-2.5 py-0.5 text-[10px] font-mono font-medium text-emerald-400 uppercase",
        variant === 'muted' && "border-border bg-card/60 px-3 py-1 text-[11px] font-medium text-zinc-400",
        variant === 'success' && "bg-emerald-950/25 border-emerald-900/35 px-2 py-0.5 text-[10px] font-medium text-emerald-400 uppercase",
        className
      )}
      {...props}
    >
