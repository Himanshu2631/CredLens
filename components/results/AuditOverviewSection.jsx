          ...
          <div className="rounded-lg p-5 border border-border/40 bg-zinc-900/10 flex flex-col justify-between select-none">
            ...
            <div className="mt-3 flex flex-wrap gap-1.5 max-h-[48px] overflow-y-auto pr-1">
              {auditedTools.map((t) => (
                <span 
                  key={t.id}
                  className="inline-flex items-center rounded bg-zinc-900 border border-border/80 px-1.5 py-0.5 text-[8.5px] font-medium text-zinc-400"
                >
                  {t.name}
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 pt-3 border-t border-border/30">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            className="h-8 gap-1.5 text-[10px] uppercase font-mono tracking-wider border border-border/60 hover:border-zinc-700 bg-zinc-900 hover:bg-zinc-800 text-zinc-300"
          >
            {copied ? (
              <>
