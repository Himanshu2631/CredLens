...
export default function Footer() {
  ...
  return (
    <footer className="w-full border-t border-zinc-900 bg-black py-8 md:py-12 transition-colors duration-300">
      <Container>
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
            ...
            <div className="flex items-center gap-1.5 text-xs text-zinc-500 font-mono ml-0 md:ml-4">
        ...
        <div className="mt-8 pt-6 border-t border-zinc-950 flex flex-col sm:flex-row items-center justify-between gap-4">
